...
class CartItem implements Arrayable, Jsonable {
	 ...
	 * @return CartItem
	 */
	public static function fromAttributes( $id, $name, $subtitle, $price, $netPrice, $vatLabel, $urlImg, array $options = [] ) {
		return new self( $id, $name, $subtitle, $price, $netPrice, $vatLabel, $urlImg, $options );
	}
